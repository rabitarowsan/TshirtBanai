...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="color" value="#ffffff" id="text-color" onchange="updateTextColor()" style="display: inline-block; vertical-align: middle;">
            <br>
            ...
            <button class="btn btn-primary" onclick="addTextToCanvas()">Add Text to Canvas</button>

        </div>

        <div class="col-md-6">
            <div id="tshirt-div" class="text-center">
                <img id="tshirt-backgroundpicture" src="https://cdn.ourcodeworld.com/public-media/gallery/gallery-5d5afd3f1c7d6.png" class="img-fluid border-0" alt="T-Shirt Image">
